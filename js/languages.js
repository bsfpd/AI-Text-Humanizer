...
const LANGUAGES = {
    id: {
        ...
        cliches: [
            ...
            { pattern: /\bBerdasarkan\s+(?:(?:studi|ilustrasi|analisis|uraian|penjelasan|paparan|data|kajian)\s+)?(?:kasus|soal|studi|permasalahan)?\s*(?:di atas|tersebut),?\s*/gi, replacement: "Mencermati paparan kasus di atas, " },
            ...
            // 8. Academic Discussion & IT Case-Study Phrases (Anti-GPTZero 4.10b)
            { pattern: /\bizin menyampaikan tanggapan atas pertanyaan diskusi terkait\b/gi, replacement: "perkenankan saya menyampaikan pandangan mengenai topik diskusi perihal" },
            { pattern: /\bizin menyampaikan tanggapan atas\b/gi, replacement: "perkenankan saya mengemukakan tanggapan mengenai" },
            { pattern: /\bpertanyaan diskusi terkait\b/gi, replacement: "topik diskusi seputar" },
            { pattern: /\bpertanyaan diskusi mengenai\b/gi, replacement: "fokus diskusi tentang" },
            { pattern: /\bstudi kasus perencanaan dan pengembangan sistem informasi\b/gi, replacement: "studi kasus perancangan serta implementasi sistem informasi" },
            { pattern: /\bperencanaan dan pengembangan sistem informasi\b/gi, replacement: "perancangan serta implementasi sistem informasi" },
            { pattern: /\bsistem informasi pada\b/gi, replacement: "sistem informasi di" },
            { pattern: /\bSesuai ketentuan, berikut adalah dua asumsi logis yang digunakan dalam analisis tanpa mengubah data utama kasus:\b/gi, replacement: "Berdasarkan kaidah analisis, terdapat dua premis rasional yang mendasari kajian ini tanpa mengubah esensi data kasus:" },
            { pattern: /\bberikut adalah dua asumsi logis yang digunakan dalam analisis tanpa mengubah data utama kasus\b/gi, replacement: "terdapat dua premis rasional yang mendasari kajian ini tanpa mengubah esensi data kasus" },
            { pattern: /\bberikut adalah dua asumsi logis\b/gi, replacement: "terdapat dua premis rasional" },
            { pattern: /\btanpa mengubah data utama kasus\b/gi, replacement: "tanpa merombak esensi data kasus" },
            { pattern: /\btelah memiliki komputer\/laptop kantor dan jaringan internet yang berfungsi stabil\b/gi, replacement: "sudah ditunjang fasilitas komputer kantor serta koneksi internet yang andal" },
            { pattern: /\btelah memiliki\b/gi, replacement: "kini telah ditunjang" },
            { pattern: /\bkomputer\/laptop kantor\b/gi, replacement: "fasilitas komputer kantor" },
            { pattern: /\bjaringan internet yang berfungsi stabil\b/gi, replacement: "koneksi internet yang stabil dan andal" },
            { pattern: /\bberfungsi stabil\b/gi, replacement: "beroperasi secara stabil dan optimal" },
            { pattern: /\bdapat difokuskan sepenuhnya untuk pengadaan jasa analisis, perancangan, pembuatan perangkat lunak, serta instalasi cloud hosting\/server lokal\b/gi, replacement: "dapat dialihkan secara maksimal guna pembiayaan jasa analisis, perancangan, pengembangan software, hingga sewa cloud server" },
            { pattern: /\bdapat difokuskan sepenuhnya untuk\b/gi, replacement: "dapat dialihkan seutuhnya guna" },
            { pattern: /\bdifokuskan sepenuhnya untuk\b/gi, replacement: "diarahkan secara maksimal demi" },
            { pattern: /\bpembuatan perangkat lunak\b/gi, replacement: "pengembangan software" },
            { pattern: /\bcloud hosting\/server lokal\b/gi, replacement: "layanan cloud server maupun server lokal" },
            { pattern: /\btanpa terbebani pembelian unit PC baru\b/gi, replacement: "tanpa perlu menguras anggaran untuk belanja komputer baru" },
            { pattern: /\btanpa terbebani pembelian unit\b/gi, replacement: "tanpa terbebani belanja unit" },
            { pattern: /\bpembelian unit PC baru\b/gi, replacement: "belanja unit komputer anyar" },
            { pattern: /\bunit PC baru\b/gi, replacement: "komputer anyar" },
            { pattern: /\bPemilik dan kedua staf administrasi terbiasa mengoperasikan komputer dasar, aplikasi perkantoran, dan ponsel pintar\b/gi, replacement: "Pihak pemilik bersama kedua staf administrasi telah terbiasa memakai komputer, software kantor, maupun smartphone" },
            { pattern: /\bterbiasa mengoperasikan\b/gi, replacement: "sudah familier menggunakan" },
            { pattern: /\bkomputer dasar\b/gi, replacement: "perangkat komputer" },
            { pattern: /\baplikasi perkantoran\b/gi, replacement: "software perkantoran" },
            { pattern: /\bponsel pintar\b/gi, replacement: "smartphone" },
            { pattern: /\bkurva pembelajaran\b/gi, replacement: "proses adaptasi dan pembelajaran" },
            { pattern: /\brelatif singkat dan tidak memerlukan biaya pelatihan khusus yang mahal\b/gi, replacement: "akan berjalan relatif cepat tanpa perlu mengalokasikan biaya pelatihan khusus" },
            { pattern: /\brelatif singkat\b/gi, replacement: "relatif cepat" },
            { pattern: /\btidak memerlukan biaya pelatihan khusus yang mahal\b/gi, replacement: "tanpa perlu mengalokasikan biaya pelatihan khusus" },
            { pattern: /\bbiaya pelatihan khusus yang mahal\b/gi, replacement: "biaya pelatihan khusus yang besar" },
...
const HUMANIZER_DICTIONARY = {
    id: {
        ...
        "memilih": ["memprioritaskan", "memilih", "menentukan pilihan pada"],
        ...
        "berkembang": ["tumbuh pesat", "berevolusi", "meluas", "kian dinamis"],
        ...
        "belajar": ["mempelajari", "mendalami", "menekuni", "belajar"],
        ...
        "faktor": ["variabel", "parameter", "unsur", "faktor"],
        "alasan": ["pertimbangan", "alasan", "argumen", "dasar pemikiran"],
        "asumsi": ["premis", "anggapan", "asumsi"],
