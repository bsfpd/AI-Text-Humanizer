...
const LANGUAGES = {
    id: {
        ...
        cliches: [
            ...
            { pattern: /\bkurva pembelajaran\b/gi, replacement: "proses adaptasi" },
            { pattern: /\brelatif singkat dan tidak memerlukan biaya pelatihan khusus yang mahal\b/gi, replacement: "cenderung lekas dan tidak menuntut anggaran pelatihan yang besar" },
            { pattern: /\brelatif singkat\b/gi, replacement: "cenderung lekas" },
            { pattern: /\btidak memerlukan biaya pelatihan khusus yang mahal\b/gi, replacement: "tidak membutuhkan anggaran pelatihan khusus yang tinggi" },
            { pattern: /\bbiaya pelatihan khusus yang mahal\b/gi, replacement: "anggaran kursus atau pelatihan besar" },
